...
add wave -noupdate -max 10.0 -radix unsigned -radixshowbase 0 /gen_trazas_start_then_ncs_low/cnt_T
add wave -noupdate /gen_trazas_start_then_ncs_low/nRst
add wave -noupdate -expand -group Antecedente /gen_trazas_start_then_ncs_low/start
add wave -noupdate -expand -group Antecedente /gen_trazas_start_then_ncs_low/rdy
...
WaveRestoreCursors {{Cursor 1} {1193 ns} 0}
